...
//  * @extends {ViewBase}
//  */
// export default class ClickGetPrize_csjc extends ViewBase {
//     constructor() {
//         super();
//     }
...
//         //EventMgr.regOnceEvent(EventDef.AD_WudianBanner_LoadComplete, this, this.WudianLoadComplete);
//     }
...
//         CachedWXBannerAd_csjc.show_csjc();
//     }
//     /**
//      * 狂点按钮逻辑
//      * 
...
//      */
//     BannerClicked() {
//         EventMgr_csjc.dispatch_csjc(EventDef_csjc.AD_WudianBanner_Hide_csjc);
//         this._bannerClicked = true;
//         this._clickTime = this._needClickTime;
//         this._clickTime_PBar$Bar.width = this._clickBarOriginalWidth;
